...
public class MIDASFormActivity extends TestActivity {
    private static final String LOG_TAG = TestActivity.class.getSimpleName();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate( savedInstanceState );
        this.setContentView( R.layout.activity_midasform );
        ...
        TEST_IMAGE.setImageDrawable(
                AppCompatResources.getDrawable( this, R.drawable.test_midas ) );

        // General
        if ( ACTION_BAR != null ) {
            ACTION_BAR.setTitle( R.string.lbl_test_midas );
    ...
    public void init()
    {
        ...
        if ( player == null ) {
            player = new MIDASFormPlayer( MIDASForm );
        }
    ...
    @Override
    public MIDASFormPlayer getFormPlayer()
    {
        return player;
    }
    ...
    public static Form MIDASForm;
    public static MIDASFormPlayer player;
}
